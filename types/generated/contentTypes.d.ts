...
export interface ApiAboutAbout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stat_clients: Schema.Attribute.Integer;
    stat_experts: Schema.Attribute.Integer;
    stat_projects: Schema.Attribute.Integer;
    stat_years: Schema.Attribute.Integer;
...
export interface ApiFormationFormation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instructor: Schema.Attribute.JSON;
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta1_link: Schema.Attribute.String;
...
export interface ApiPackPack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    currency: Schema.Attribute.String & Schema.Attribute.DefaultTo<'FCFA'>;
    ...
    promo_price: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    avatar_file: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
